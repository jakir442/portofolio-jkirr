...
// icons
import { BsArrowRight, bsarr } from 'react-icons/bs';
    ...
    <div className="h-full bg-primary/30">
      <div className="container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full">
        ...
        <div className="flex flex-col w-full max-w-[700px] ">
          ...
          //   let's <span className="text-accent"></span>
          // </motion.h2>
          {/* form */}
          <motion.form variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit="hidden" className="flex-1 flex flex-col gap-6 w-full mx-auto">
            ...
            <button className="btn rounded-full border border-white/50 max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-accent group">
              ...
              <BsArrowRight
                className="-transition-y-[120%] opacity-0 group-hover:flex group-hover:-translate-y-0 
